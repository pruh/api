...
func (c *Controller) GetAll(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		http.Error(w, "Error while querying notifications.", http.StatusInternalServerError)
		return
	}
	...
	if err != nil {
		...
		http.Error(w, "Cannot marshal notifications.", http.StatusInternalServerError)
		return
	}
...
func (c *Controller) Get(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		http.Error(w, "Notification UUID is malformed.", http.StatusBadRequest)
		return
	}
	...
	if err != nil {
		...
		http.Error(w, "Error while querying notification.", http.StatusInternalServerError)
		return
	}
	if notification == nil {
	...
	if err != nil {
		...
		http.Error(w, "Cannot marshal notification.", http.StatusInternalServerError)
		return
	}
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(http.StatusOK)
